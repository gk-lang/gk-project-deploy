    ...
    <div class="form-box">
      ...
      <div class="content">
        <div v-if="stepIndex === 1" class="step1-content">
          <div class="bt-person" @click="goNextStep('person')">
            <span>个人开发者</span>
          </div>
          <div class="bt-enterprise" @click="goNextStep('enterprise')">
            <span>企业开发者</span>
          </div>
          <div class="bt-pre">
        ...
        <div v-if="stepIndex === 2" class="step2-content">
          ...
          <div class="bt-view">
            <el-checkbox
              label="我已阅读并同意"
              value="1"
              v-model="isAgreeService"
            />
            <el-link type="primary" :underline="false"
              >《九州通物流开放平台服务使用条款》</el-link
            >
          </div>
          <div class="bt-next">
            ...
            <div
              :class="['bt-right', { 'is-disable': isDisableSubmitBtn }]"
...
function submitFormData() {
  ...
  if (!isAgreeService.value) return;
